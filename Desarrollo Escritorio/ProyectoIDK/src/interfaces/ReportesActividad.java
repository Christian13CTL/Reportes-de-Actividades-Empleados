 ...
 * @author Christian
 */
public class ReportesActividad extends javax.swing.JPanel {

    private Connection conexion;

    public ReportesActividad(Connection conexion) {
        initComponents();
    ...
    private void reporte(String fechaInicial, String fechaFinal) {
        try {
            ...
            JasperReport reporte = JasperCompileManager.compileReport("D:\\Ingeniería en Software (II Semestre)\\IV Semestre\\Metodologías Ágiles\\Proyecto\\IDK_Chancusig_Jaramillo_Zamora\\Desarrollo Escritorio\\ProyectoIDK\\src\\reportes\\reporteActividadesG.jrxml");
